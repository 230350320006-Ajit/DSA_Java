...
class BinarySearchTree {
	...
	//count number of Leaf - node in tree
    public int countLeaf(Node trav)
    {
        int count = 0;
        if(trav.left == null && trav.right==null)
        {
            ...
            count = count + countLeaf(trav.left);
            count = count + countLeaf(trav.right);
            return count;
        }
    }
